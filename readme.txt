...
1. The code cannot be directly run without downloading certain dependencies from the NOAA Global Historical Climatology
...
2. In one sentence, this module estimates the overall water savings when weather-based irrigation controllers are
...
3. This module can be thought of as three sections. The first is the input handling. A key challenge here was filtering
